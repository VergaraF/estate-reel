...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2014 at 05:07 AM
...
(2, 'Fabian', 'Vergara', 'hg-faver@hotmail.com', '222 324 2344', 'faver', 'd3yTTT.8w5.oo', 'd341cc51ea668a4bd7475905756b864efca1138c6d3e32a0ce0c0357d0f7acc3', 'Landlord', 'Regular'),
...
(5, 'Admin', 'Boss', 'admin@gmail.com', '514 613 1234', 'admin', '3e.0OcrBj1OLc', '3ec4782d0f4a19b6e726cb0a13b54f9c7c02de93f7397439c43e08a7ab7581d3', 'Landlord', 'Admin');
...
--
ALTER TABLE `conversation`
MODIFY `conversationId` int(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `conversation_reply`
--
ALTER TABLE `conversation_reply`
MODIFY `cr_id` int(6) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=17;
--
